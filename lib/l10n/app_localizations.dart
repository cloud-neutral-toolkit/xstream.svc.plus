...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'dnsOverHttpsHint':
          'Controls the Xray Secure DNS transport. System DNS still uses Packet Tunnel bootstrap resolvers until the local Secure DNS proxy is added.',
...
curl -I --proxy socks5h://127.0.0.1:1080 --max-time 15 https://grok.com''',
    ...
    'zh': {
      ...
      'dnsOverHttps': 'DNS over HTTPS',
      'dnsOverHttpsHint':
          '控制 Xray Secure DNS 的传输方式。在本地 Secure DNS proxy 完成前，系统 DNS 仍使用 Packet Tunnel 的 bootstrap 解析器。',
      'tunStatus': 'TUN 状态',
